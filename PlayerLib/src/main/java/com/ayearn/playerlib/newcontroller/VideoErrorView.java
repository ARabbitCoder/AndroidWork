...
public class VideoErrorView extends FrameLayout {
        ...
        video_error_retry.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (onErrorCallback != null) {
                    onErrorCallback.onRetry(curStatus);
    ...
    public void setOnVideoControlListener(OnErrorCallback onVideoControlListener) {
        this.onErrorCallback = onVideoControlListener;
    }
}
