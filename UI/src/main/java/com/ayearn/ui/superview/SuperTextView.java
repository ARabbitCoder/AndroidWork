...
import com.ayearn.ui.superview.adjusters.PressAdjuster;
...
public class SuperTextView extends TextView {
  ...
  protected List<Adjuster> adjusterList = new ArrayList<>();
  protected List<Adjuster> touchAdjusters = new ArrayList<>();
  ...
  public static abstract class Adjuster {
    ...
    public void onFocusChange(SuperTextView v, boolean haveFocus){};
