...
public class NumberProgressView extends View {
    ...
    private void initData() {
        ...
        //设置进度条画笔的宽度
        int paintProgressWidthPx = DensityUtil.getInstance().dip2px(context, paintProgressWidth);

        //设置百分比文字的尺寸
        int paintTextSizePx = DensityUtil.getInstance().sp2px(context, paintTextSize);
