...
//    	String str = "0123456helloKitty1295422846423";
    	String result="0";
    	String account="a00123456";
    	String timeStamp="1315966912251";
    	String str = result+account+timeStamp;
    	String Digest = hex_sha1(str);
    	String szSrc = result+'$'+account+'$'+timeStamp+'$'+Digest;
    	String key = "123456789abc123456789abc";
        byte[] keyBytes = key.getBytes();
        //String szSrc="0$a00123456$1315966912251$84ce97b8c103285739d281b40832cee64fb7c875";
        System.out.println("加密前的字符串:" + szSrc);
        byte[] encoded = EncryptUtil.encryptMode(keyBytes, szSrc.getBytes());
        System.out.println("加密后的字符串:" + new String( encoded));
        String endTxt = URLEncoder.encode(Base64.encode(encoded), "utf-8");
        System.out.println(endTxt);
        System.out.println(str+"的SHA1的值为：" + hex_sha1(str) + ",length=" + hex_sha1(str).length());
    }*/
}